package com.wes.myapp.ui.theme.Screens.products
...
import com.wes.myapp.navigation.ROUTE_VIEW_UPLOAD_PRODUCT
    ...
    Column(modifier = modifier,) {
        ...
        Column(
            ...
            Button(onClick = {
                ...
                navController.navigate(ROUTE_VIEW_UPLOAD_PRODUCT)
...
fun AddProductsScreenPreview() {
    AddProducts(rememberNavController())
